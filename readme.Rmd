...
### Jump to:
**Command line tools** [grep](#grep) | [head/tail](#headtail) | [ffmpeg](#ffmpeg) | [pdftk](#pdftk) | [esridump](#esridump) | [wget](#wget) | [file](#file) | [sed](#sed) | [wc](#wc) | [imagemagick](#imagemagick) | [libpst](#libpst) | [gunzip](#gunzip)

**R packages** [shortcut keys](#shortcut-keys) | [base](#base) | [readr](#readr) | [scales](#scales) | [ggpmisc](#ggpmisc) | [dplyr](#dplyr) | [plyr](#plyr) | [clipr](#clipr) | [googlesheets4](#googlesheets4)

**Math for journalists** [Standard deviation](#standard-deviation) | [Rate comparisons](#rate-comparisons) | [Odds ratios](#odds-ratios) | [Making sense of symbols](#making-sense-of-symbols)

**Browser tricks** [PDFs](#pdfs) | [Video](#video)

**Troubleshooting** [Location errors](#location-errors)

**Convenience files** [U.S. states](#us-states) | [N.C. counties](#us-states)
...
```
The [readr package](#readr) is my preferred method for importing data, sometimes [it chokes](https://github.com/tidyverse/readr/issues/306) on strange file encodings even with the `locale` parameter set. So this method is worth trying.
...
```
Use the `url` function from base R to pull formatted data posted in public gists, [like these convenience files](#convenience-files). Swap out the delimiter function (read_csv, read_delim, etc) as needed. Get the URL by clicking "Raw" on the Gist page.
